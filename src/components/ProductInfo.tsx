...
const ProductInfo = () => {
  ...
  return (
    <div className="flex flex-col py-6 ">
      ...
      <div>
        <h1 className="font-bold text-5xl mb-5">{productInfo.title}</h1>
      </div>
      <div>
      ...
      <div className="flex items-center gap-2">
        <div className="flex items-center bg-colorLightGrayishBlue py-3 rounded-lg px-4 w-[26%] justify-between">
          <div
            onClick={handleMinusQnt}
            className={`active:opacity-50 select-none ${qnt < 1 ?"pointer-events-none disabled":"cursor-pointer"} `}
          >
            <Image
              alt="minus button"
        ...
        <div>
          <button onClick={handleAddToCartButtonClick} className="flex select-none font-bold items-center gap-2 bg-colorOrange active:opacity-50 px-20 py-3 rounded-lg">
