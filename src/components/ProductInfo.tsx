      ...
      <div className="flex items-center gap-2">
        <div className="flex items-center bg-colorLightGrayishBlue py-3 rounded-lg px-4 w-[26%] justify-between">
          <div
            ...
            className={`active:opacity-50 ${qnt < 1 ?"pointer-events-none disabled":"cursor-pointer"} `}
          >
            <Image
              alt="minus button"
        ...
        <div>
          <button onClick={handleAddToCartButtonClick} className="flex font-bold items-center gap-2 bg-colorOrange active:opacity-50 px-20 py-3 rounded-lg">
